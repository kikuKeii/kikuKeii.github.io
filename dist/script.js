...
const textArray = ["Programmer.", "Web Developer.", "seorang yang dapat bekerja dengan baik."];
...
function type() {
    if (charIndex < textArray[textArrayIndex].length) {
        if (!cursorSpan.classList.contains("typing")) cursorSpan.classList.add("typing2");
...
function erase() {
    if (charIndex > 0) {
        if (!cursorSpan.classList.contains("typing2")) cursorSpan.classList.add("typing2");
